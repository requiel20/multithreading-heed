...
public class NodeInfoFrame extends JFrame {
	...
	public NodeInfoFrame() {
		...
		this.add(fxpanel);
		fxpanel.setBounds(0, yTemp, (int) (this.frameActualContentSize.getWidth()) - 1,
				(int) (this.frameActualContentSize.getHeight()) - 1);
	...
	private String getHTMLTemplate() {
		...
		try {
			BufferedReader in = new BufferedReader(new FileReader(
					"C:\\Users\\dezio\\workspace\\SetRadius+Finalise\\ResultGraphic\\NodeInfoTemplate.html"));
			String str;
